...
const Section2 = () => {
  return (
    <div>
       ...
       <div className='container p-5 md:my-20 mx-auto md:px-6'>
...
<svg viewBox="0 0 24 24" fill="none" className='w-[136px] h-[57px] transition-all  hover:fill-white
...
<svg fill="#000000"    version="1.1" id="Capa_1" 
	 viewBox="0 0 407.834 407.834"  className='w-[300px] h-[58px] transition-all  hover:fill-white
...
<div
class=" mx-auto max-w-[600px] grid rounded-xl bg-white  ">
<div className='flex  top-0'>
  
<svg  viewBox="0 0 24 24"  className='w-[300px] h-[60px] transition-all fill-white    
